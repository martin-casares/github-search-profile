								...
								<div className="card-content" key={project.id}>
									<div className="card-body">
										<div className="card-text">
											...
											<div className="card-text-body">{project.git_url}</div>
											<div className="card-text-body">
												Created at: {formatToYearMonthDay(project.created_at)}
											</div>
											<div className="card-text-footer">
												<span>
													<TbGitFork size={14} style={{ marginRight: '4px' }} />
													{project.forks}
												</span>
												<span>
													<FaRegStar size={14} style={{ marginRight: '4px' }} />
													{project.stargazers_count}
												</span>
												{/* <span>
													<FaFileShield size={14} style={{ marginRight: '4px' }} />
													{project.licence}
												</span> */}
												<span>
